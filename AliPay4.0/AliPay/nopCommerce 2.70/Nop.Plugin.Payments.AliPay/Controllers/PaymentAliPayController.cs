...
{
    public class PaymentAliPayController : BaseNopPaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("Nop.Plugin.Payments.AliPay.Views.PaymentAliPay.Configure", model);
        }
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("Nop.Plugin.Payments.AliPay.Views.PaymentAliPay.PaymentInfo", model);
        }
