...
{
    public partial class WxPayApi
    {
        static ConfigurationModel WxPayConfig = null;

        public WxPayApi(ConfigurationModel modoel)
        {
            WxPayConfig = modoel;
        }
        public WxPayApi()
        ...
        */
        public WxPayData Micropay(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = new HttpService(WxPayConfig).Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
        ...
        */
        public WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            inputObj.SetValue("appid", WxPayConfig.APPID);//公众账号ID
            inputObj.SetValue("mch_id", WxPayConfig.MCHID);//商户号
            inputObj.SetValue("nonce_str", app_code.WxPayApi.GenerateNonceStr());//随机字符串
            inputObj.SetValue("sign", inputObj.MakeSign());//签名
            ...
            string response = new HttpService(WxPayConfig).Post(xml, url, false, timeOut);//调用HTTP通信接口提交数据
        ...
        */
        public WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = new HttpService(WxPayConfig).Post(xml, url, true, timeOut);
        ...
        */
        public WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = new HttpService(WxPayConfig).Post(xml, url, true, timeOut);//调用HTTP通信接口提交数据到API
	    ...
	    */
        public WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            string response =new HttpService(WxPayConfig).Post(xml, url, false, timeOut);
        ...
        */
        public WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            // Portal.MVC.Logger.Info("WxPayApi" + "UnfiedOrder request : " + xml);
            // Portal.MVC.Logger.Info("time_expire" + inputObj.GetValue("time_expire"));
            string response =new HttpService(WxPayConfig).Post(xml, url, false, timeOut);
